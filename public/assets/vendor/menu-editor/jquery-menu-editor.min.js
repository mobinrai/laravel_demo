function MenuEditor(l, t) {
    ...
    $.extend(!0, r, t);
    var s = null, n = !0, a = null, o = null, e = r.iconPicker,
    ...
    function p(e) {
        return $("<a>").addClass(e.classCss).addClass("clickable").attr("data-id", e.dataid).attr("href", '#').html(e.text)
    }

    function f(id) {
        var e = $("<div>").addClass("btn-group float-right"),
            s = p({classCss: "btn btn-success btn-sm btnEdit", text: r.labelEdit, dataid: id}),
            t = p({classCss: "btn btn-danger btn-sm btnRemove", text: r.labelRemove, dataid: id}),
            l = p({
    ...
    i.sortableLists(r.listOptions), c.on("change", function (e) {
        ...
        e.preventDefault();
        var s = $(this).closest("ul"), t = $(this).closest("li");
        ...
        e.preventDefault();
        var s = $(this).closest("li"), t = s.prev("li");
        ...
        (o = e).attr("disabled", false), s = null
        ...
        var s = f(), t = $("<span>").addClass("txt").text(e.title), l = $("<i>").addClass(e.icon),
            n = $("<div>").css({overflow: "auto"}).append(l).append("&nbsp;").append(t).append(s),
            o = $("<li>").data(e);
        ...
        if (null !== s) {
            ...
            var t = function d(e, s) {
                var p = void 0 === s ? 0 : s, u = 0 === p ? i : $("<ul>").addClass("pl-0").css("padding-top", "10px");
                return $.each(e, function (e, s) {
                    var t = void 0 !== s.children && $.isArray(s.children),
                        l = {title: "", /*link: "",*/ icon: "empty", target: "_self", text: ""}, n = $.extend({}, s);
                    t && delete n.children, $.extend(l, n);
                    var o = $("<li>").addClass("list-group-item pr-0");
                    o.data(l);
                    var i = $("<div>").css("overflow", "auto"), r = $("<i>").addClass(s.icon),
                        a = $("<span>").addClass("txt").append(s.title).css("margin-left", "10px"), c = f(s.id);
...
!function (L) {
    L.fn.sortableLists = function (e) {
        var s = L("body").css("position", "relative"), t = {
                currElClass: "",
                placeholderClass: "",
        ...
        return this.on("mousedown touchstart", function (e) {
            ...
            if (!(!1 !== h.isDragged || d.ignoreClass && s.hasClass(d.ignoreClass))) {
                ...
                var t = s.closest("li"), l = L(this);
                t[0] && (d.onDragStart(e, t), function (e, s, t) {
                    h.isDragged = !0;
                    var l = parseInt(s.css("margin-top")), n = parseInt(s.css("margin-bottom")),
                        o = parseInt(s.css("margin-left")), i = parseInt(s.css("margin-right")), r = s.offset(),
                        a = s.innerHeight();
                    h.rootEl = {el: t, offset: t.offset(), rootElClass: t.attr("class")}, h.cEl = {
                        el: s,
                        mT: l,
                        mL: o,
                        mB: n,
        ...
        function v(e) {
            if (h.isDragged) {
                ...
                "touchmove" === e.type && m(e), e.pageX || ((i = e).pageY = h.pY, i.pageX = h.pX, i.clientY = h.cY, i.clientX = h.cX), t.scrollTop() > h.rootEl.offset.top - 10 && e.clientY < 50 ? h.upScroll ? (e.pageY = e.pageY - d.scroll, L("html, body").each(function (e) {
                    ...
                    var l = t.outerHeight(!1), n = e.pageY - t.offset().top;
                    d.insertZonePlus ? n < 14 ? function (e, s, t) {
                        ...
                        if (!t && e.pageX - s.offset().left > d.insertZone) {
                            var l = s.children(), n = s.children(d.listSelector).first();
                        ...
                        L("#sortableListsHintWrapper", h.rootEl.el).length && f.unwrap();
                        if (!t && e.pageX - s.offset().left > d.insertZone) {
                            var l = s.children(), n = s.children(d.listSelector).last();
                        ...
                        if (e.pageX - s.offset().left < d.insertZone) {
                            ...
                            var t = s.children(), l = s.children(d.listSelector).first();
                        ...
                        if (e.pageX - s.offset().left < d.insertZone) {
                            ...
                            var t = s.children(), l = s.children(d.listSelector).last();
        ...
        function b(e) {
            var t = h.cEl, l = L("#sortableListsHint", h.rootEl.el), n = f[0].style, o = null, i = !1,
