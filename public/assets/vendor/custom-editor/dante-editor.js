...
(function() {
    ...
    Dante.Editor = (function(_super) {
        ...
        Editor.prototype.initialize = function(opts) {
            ...
            this.upload_url = opts.upload_url || "http://dulwa.dev/story/image";
            ...
            titleplaceholder = opts.title_placeholder || 'Story Title';
    ...
    Dante.View.Behavior.Save = (function(_super) {
        ...
        Save.prototype.checkforStore = function() {
            ...
            if (this.content === this.editor.getContent()) {
                utils.log("content not changed skip stock");
                return this.store();
            } else {
                ...
                var title= $(this.el).find('.graf--first').text();
                return $.ajax({
...
(function() {
    ...
    Dante.View.TooltipWidget.Embed = (function(_super) {
        ...
        Embed.prototype.getEmbedFromNode = function(node) {
           ...
           console.log('URl',url);
             $.getJSON(url).success((function(_this) {
