...
<div class="pb-5">
    <div class="row g-5">
      @include('admin.includes.top_dashboard')
...
<div class="mx-n6 bg-white px-6 pt-7 border-y border-300">
    <div class="row">
        ...
        <div class="table-responsive mx-n1 px-1 scrollbar">
            ...
            <thead>
                <tr>
                <th class="white-space-nowrap fs--1 border-top ps-0 align-middle py-1">
                    <div class="form-check mb-0 fs-0"><input class="form-check-input" type="checkbox"></div>
                </th>
                <th class="sort border-top white-space-nowrap align-middle py-1" scope="col"></th>
                <th class="sort border-top white-space-nowrap align-middle py-1" scope="col" style="min-width:360px;" data-sort="product">PRODUCT</th>
                <th class="sort border-top align-middle py-1" scope="col" data-sort="customer" style="min-width:200px;">CUSTOMER</th>
                <th class="sort border-top align-middle py-1" scope="col" data-sort="rating" style="min-width:110px;">RATING</th>
                <th class="sort border-top align-middle py-1" scope="col" style="max-width:350px;" data-sort="review">REVIEW</th>
                <th class="sort border-top text-start ps-5 align-middle py-1" scope="col" data-sort="status">STATUS</th>
                <th class="sort border-top text-end align-middle py-1" scope="col" data-sort="time">TIME</th>
                <th class="sort border-top text-end pe-0 align-middle py-1" scope="col">ACTION</th>
                </tr>
            </thead>
